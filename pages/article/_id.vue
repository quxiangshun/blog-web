        ...
        <el-row type="flex">
            <el-col :md="18" :xs="24" :sm="24" >
                <div class="article-left">
                    ...
                    <div>
                        ...
                        <el-card>
                            <jh-comment :userId="userId" :userImage="userImage"
            ...
            <el-col class="hidden-sm-and-down" :md="6">
                <el-row>
                    <el-col>
                        <jh-affix :offset="80">
                           <jh-directory parentClass="article-content"></jh-directory>
                        </jh-affix>
                    </el-col>
                </el-row>
            </el-col>
...
// 固钉
import JhAffix from '@/components/common/Affix/index.vue'
// 文章目录
import JhDirectory from '@/components/common/Directory/index.vue'

// 评论组件
import JhComment from '@/components/common/Comment'  
export default {
    components: {JhAffix, JhDirectory, JhComment},
